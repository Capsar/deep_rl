...
class SeriesDecompositionLayer(nn.Module):
    """
    Series decomposition block
    """

    def __init__(self, kernel_size):
        super(SeriesDecompositionLayer, self).__init__()
...
class DLinear(nn.Module):
    ...
    def __init__(self, seq_len, pred_len, enc_in, kernel_size=9, individual=False):
        super(DLinear, self).__init__()
        self.seq_len = seq_len
        self.pred_len = pred_len

        # Decomposition Kernel Size
        self.decomposition = SeriesDecompositionLayer(kernel_size)
